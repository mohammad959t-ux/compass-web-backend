...
export const projects: Project[] = [
  { id: "PRJ-1", name: "Lumen Payments", status: "active", owner: "Amina Al Noor", budget: 18000 },
  { id: "PRJ-2", name: "Atlas Ventures", status: "paused", owner: "Javier Suarez", budget: 12000 },
  { id: "PRJ-3", name: "Veridian Health", status: "complete", owner: "Priya Singh", budget: 24000 }
];
